...
public class IndustryExperience {
  ...
  private void addTitleIndustryExperience(XSLFSlide slide) {
    ...
    Util.setSizeAndPosition(title, START_SECOND_COLUMN, STARTING_VERTICAL_POINT_FIRST_ROW_SHAPES, WIDTH_EXPERTISE,
        0.68);
  }

  private void addIndustryExperienceBackgroundShape(XSLFSlide slide) {
    XSLFTextShape background = slide.createAutoShape();
    Util.setSizeAndPosition(background, START_SECOND_COLUMN,
        STARTING_VERTICAL_POINT_FIRST_ROW_SHAPES + HEIGHT_TITLE_SHAPE, WIDTH_EXPERTISE, HEIGHT_EXPERTISE_BACKGROUND);
