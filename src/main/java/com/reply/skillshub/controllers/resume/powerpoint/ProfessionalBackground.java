...
public class ProfessionalBackground {
    ...
    private void addProfessionalBackgroundBackground(XSLFSlide slide) {
        ...
        Util.setSizeAndPosition(background, START_FIRST_COLUMN, START_SECOND_ROW + HEIGHT_TITLE_SHAPE, WIDTH_FIRST_COLUMN, 8.3);
    ...
    private void addProfessionalBackground(XSLFSlide slide) {
        ...
        XSLFTextRun run = text.setText(this.pointInformation.getBackground());
        run.setFontSize(9.0);
